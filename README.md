...
Training was performed on a GPU to reduce computation time.

## Dataset

The experiments were conducted using the WESAD dataset.

The dataset is not included in this repository, but can be obtained through this link: https://www.kaggle.com/datasets/orvile/wesad-wearable-stress-affect-detection-dataset/data

The following wrist-based physiological signals were used:
- BVP (Blood Volume Pulse)
- EDA (Electrodermal Activity)
- ACC (Accelerometer)
- TEMP (Skin Temperature)

The signals were preprocessed and segmented into sliding windows before being used for classification
